...
use crate::compiler::{Span, SpanSourceId, Text};
use chumsky::prelude::*;
...
pub fn lexer(
    ...
    token
        ...
        .map_with_span(move |tok, span| (tok, Span::new(span_source_id, span)))
        .repeated()
        .then_ignore(end())
}
...
mod tests {
    ...
    use crate::compiler::analysis::test::TestDatabaseHelper;
