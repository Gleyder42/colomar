...
use crate::compiler::{
    HierarchicalSpan, Ident, Span, Spanned, SpannedBool, Text, UseRestriction, ACTIONS_LEN,
...
pub enum CallArgument {
    Named(Ident, CallChain, HierarchicalSpan),
    Pos(CallChain),
}
...
pub enum Call {
    ...
    /// - "Hello World"
    /// - "Greetings"
    String(Text, HierarchicalSpan),
    /// A number literal
    /// ## Example
    /// - 12
    /// - 1.5
    /// - 0
    Number(Text, HierarchicalSpan),
}
