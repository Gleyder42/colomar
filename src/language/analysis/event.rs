...
pub(in super) fn query_event_def_by_id(db: &dyn DefQuery, event_decl_id: EventDeclarationId) -> QueryTrisult<im::EventDefinition> {
...
pub(in super) fn query_event_properties(db: &dyn DeclQuery, actions: Vec<Action>) -> QueryTrisult<Vec<PropertyDecl>> {
    actions.into_iter()
...
pub(in super) fn query_event_def(db: &dyn DefQuery, event_def: ast::EventDefinition) -> QueryTrisult<im::EventDefinition> {
...
pub(in super) fn query_event(db: &dyn DefQuery, event: ast::Event) -> QueryTrisult<im::Event> {
