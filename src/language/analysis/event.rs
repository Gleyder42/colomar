...
pub trait EventQuery: EventDeclQuery + ArgQuery + PropertyDeclQuery + AstDefQuery {
...
fn query_event_def_by_id(db: &dyn EventQuery, event_decl_id: EventDeclarationId) -> QueryResult<im::EventDefinition, AnalysisError> {
